...
fn main() {
    ...
    let file_path = "../Grape-slp-ec/6-3-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/7-3-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/7-4-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/8-3-8ring_matrix.csv";      
    //let file_path = "../Grape-slp-ec/8-4-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/9-3-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/9-4-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/10-3-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/10-4-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/20-4-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/30-3-8ring_matrix.csv";
    //let file_path = "../Grape-slp-ec/40-3-8ring_matrix.csv";
    /*let file_path = "../Grape-slp-ec/50-3-8ring_matrix.csv";
    */
                
    let mut bitmatrix_enc=rsv_bitmatrix::matrix_to_bitmatrix_from_csv(file_path,nr_data_block*8, nr_parity_block*8);
    //println!("bitmatrix_enc   {:?} ", bitmatrix_enc);
